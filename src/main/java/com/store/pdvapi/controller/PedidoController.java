...
public class PedidoController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Status do pedido inválido para fechamento", content = @Content(schema = @Schema(implementation = ErroResponse.class), examples = @ExampleObject(name = "StatusPedidoInvalidoFechamento", value = "{\"timestamp\":\"2026-04-01T20:12:00\",\"status\":409,\"error\":\"Conflict\",\"message\":\"Status do pedido invalido para fechamento\",\"path\":\"/pedidos/1/fechar\"}"))),
