...
public class MesaController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Dados da mesa inválidos", content = @Content(schema = @Schema(implementation = ErroResponse.class), examples = @ExampleObject(name = "MesaInvalida", value = "{\"timestamp\":\"2026-04-01T20:12:00\",\"status\":400,\"error\":\"Bad Request\",\"message\":\"Numero da mesa e obrigatorio\",\"path\":\"/mesas\"}"))),
            @ApiResponse(responseCode = "409", description = "Número da mesa já cadastrado", content = @Content(schema = @Schema(implementation = ErroResponse.class), examples = @ExampleObject(name = "MesaDuplicada", value = "{\"timestamp\":\"2026-04-01T20:12:00\",\"status\":409,\"error\":\"Conflict\",\"message\":\"Numero da mesa ja cadastrado\",\"path\":\"/mesas\"}"))),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Status da mesa inválido para abertura", content = @Content(schema = @Schema(implementation = ErroResponse.class), examples = @ExampleObject(name = "StatusMesaInvalidoAbertura", value = "{\"timestamp\":\"2026-04-01T20:12:00\",\"status\":409,\"error\":\"Conflict\",\"message\":\"Status da mesa invalido para abertura\",\"path\":\"/mesas/1/abrir\"}"))),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Status da mesa inválido para fechamento", content = @Content(schema = @Schema(implementation = ErroResponse.class), examples = @ExampleObject(name = "StatusMesaInvalidoFechamento", value = "{\"timestamp\":\"2026-04-01T20:12:00\",\"status\":409,\"error\":\"Conflict\",\"message\":\"Status da mesa invalido para fechamento\",\"path\":\"/mesas/1/fechar\"}"))),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Status da mesa inválido para liberação", content = @Content(schema = @Schema(implementation = ErroResponse.class), examples = @ExampleObject(name = "StatusMesaInvalidoLiberacao", value = "{\"timestamp\":\"2026-04-01T20:12:00\",\"status\":409,\"error\":\"Conflict\",\"message\":\"Status da mesa invalido para liberacao\",\"path\":\"/mesas/1/liberar\"}"))),
